...
const ItrSalaryPlan = () => {
  useEffect(() => {
    ...
    script.setAttribute('data-payment_button_id', 'pl_OHQ2KXA2INNEPl');
    script.async = true;
  ...
  return (
    ...
    <h5 className="text-lg font-bold text-black uppercase">Salary & HP Plan</h5>
      ...
      <h1 className='text-xl font-semibold p-2 text-center'>Proceed to pay:-</h1>
    ...
    {/* <h1 className='text-xl font-semibold px-2 text-center'>Step 2- Fill out the form by clicking the button below:-</h1>
        <Link to = "https://docs.google.com/forms/d/e/1FAIpQLSdSwD2FWQ0U9uD83Rp3UUOxspnVOZsnv9l49erkBzbhlkOmIA/viewform">
